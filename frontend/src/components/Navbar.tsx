...
const buttonPrimary =
    buttonBase + ' bg-sky-600 text-white shadow-sm hover:bg-sky-700'

const buttonSecondary =
    buttonBase + ' border border-slate-200 bg-white text-slate-800 shadow-sm hover:bg-slate-50'

const buttonGhost =
    buttonBase + ' border border-transparent text-slate-700 hover:text-sky-700 hover:bg-slate-50 shadow-none focus-visible:ring-sky-500'
                ...
                <div className='border-t border-slate-200 bg-white md:hidden'>
                    <div className='mx-auto max-w-6xl px-4 py-3 sm:px-6 lg:px-8'>
                        ...
                        <div className='mt-3 flex flex-col gap-2'>
                            {isAuthenticated ? (
                                <>
                                    <span className={`${pillGreeting} justify-center`}>
                                        Hello,&nbsp;
                                        <span className='font-semibold'>
                                            {user?.fullName}
                                        </span>
